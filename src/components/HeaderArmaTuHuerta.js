...
const HeaderArmaTuHuerta = props => {
    return (
        <>
            ...
            <ul className="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li className="nav-item dropdown d-none">
                ...
                <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                  ...
                  <li><a className="dropdown-item" href="!#">Cambiar el password</a></li>
                </ul>
              </li>
            </ul>
              ...
              <div id="myTabContent" className="tab-content">
                ...
                <div className="tab-pane fade active show" id="TabIngreso">
                  <form>
                    <div className="my-2">
                      ...
                      <div id="IngresoCelularHelp" className="form-text">Ingresa tu número celular (10 números)</div>
                    </div>
                ...
                <form>
                    ...
                    <div className="my-1">
                      ...
                      <div id="RegitroCorreosHelp" className="form-text">Regitra tu correo electrónico (máx 100 caractéres)</div>
                    </div>
                    <div className="my-1">
                      ...
                      <div id="RegitroCelularHelp" className="form-text">Regitra tu número celular (10 números)</div>
                    </div>
...
export default HeaderArmaTuHuerta
