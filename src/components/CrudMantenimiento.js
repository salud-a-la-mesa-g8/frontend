...
import {cardMantenimiento} from "./TuHuerta";


class CrudMantenimiento extends React.Component {
  state = {
    cardMantenimiento: cardMantenimiento,
  ...
  editar = (dato) => {
    var contador = 0;
    var arreglo = this.state.cardMantenimiento;
    ...
    this.setState({ cardMantenimiento: arreglo, modalActualizar: false });
  };
  ...
  insertar= ()=>{
    ...
    var lista= this.state.cardMantenimiento;
    lista.push(valorNuevo);
    this.setState({ modalInsertar: false, cardMantenimiento: lista });
  }
      ...
      <>
        <Container>
          ...
          <Table>
            ...
            <tbody>
              {this.state.cardMantenimiento.map((dato) => (
                <tr>
                  <td>{dato.titulo}</td>
...
export default CrudMantenimiento;